...
export default function AssessmentSection(){
       ...
       additionalDirections = (
        <div>
          ...
          <div>
            ...
            <div className="ml-2">5 - Highly characteristic of me/definitely true for me </div>
            <div className="ml-1">4 - Most of the time this would describe me/be true for me </div>
            <div className="ml-1">3 - Frequently characteristic of me/true for me-about 50 percent of the time</div>
            <div className="ml-1">2 - Occasionally characteristic of me/true for me-about 25 percent of the time</div>
            <div className="ml-1">1 - Not at all characteristic of me/definitely untrue for me</div>            
          </div>
        </div>
      );
    }
  ...
  if(data.section.prevSection === null){
    ...
    previous = (
      <Link to={`/assessments/${data.assessment.id}/section/${data.section.prevSection}`}>        
  ...
  if(data.section.nextSection === null){    
    ...
    next = (
      <Link to={`/assessments/${data.assessment.id}/section/${data.section.nextSection}`}>        
